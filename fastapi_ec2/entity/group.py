from sqlalchemy import (
    BigInteger, Boolean, String, DateTime, func, ForeignKey
)
...
class MemberGroup(Base):
    ...
    creator_id: Mapped[int] = mapped_column(BigInteger, ForeignKey('member.id', ondelete='CASCADE'), nullable=False)
    is_favorite: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default='false')
    is_constructed: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default='false')
...
class GroupMember(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    group_id: Mapped[int] = mapped_column(BigInteger, ForeignKey('member_group.id', ondelete='CASCADE'), nullable=False)
